  ...
  <body>
      <div class="flex items-center justify-center h-screen">
        <div class="border shadow-md py-12 px-24 rounded-md">
          ...
          @auth
          <div class="font-semibold text-center mb-12">
          ...
          @else
          <div class="flex justify-center items-center">
            <a href="{{ route('redirect') }}" class="inline-flex bg-slate-800 text-white font-semibold text-xl rounded-lg py-2 px-12 items-center space-x-1">
